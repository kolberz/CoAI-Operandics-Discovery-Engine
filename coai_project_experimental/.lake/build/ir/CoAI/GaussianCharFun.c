...
// Module: CoAI.GaussianCharFun
// Imports: public import Init public import Mathlib.Probability.Distributions.Gaussian.Real public import Mathlib.Analysis.InnerProductSpace.Basic public import Mathlib.Analysis.SpecialFunctions.Trigonometric.Basic public import CoAI.Integrability
#include <lean/lean.h>
...
lean_object* initialize_coai_CoAI_Integrability(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_coai_CoAI_GaussianCharFun(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_coai_CoAI_Integrability(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
