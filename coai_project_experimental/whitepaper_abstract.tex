...
\title{%
  \textbf{CoAI: The Calculus of AI} \\[4pt]
  \large A 5-Layer Formally Verified Pipeline from Softmax Attention \\
  to Linear-Time Random Feature Approximation with \\
...
We present \textbf{CoAI}, a formally verified \emph{certified attention stack}
...
\textbf{100\% free of domain-specific axioms and admitted proofs}. The Gaussian characteristic
...
\texttt{HasSubgaussianMGF} probability metrics. Furthermore, all integrability 
conditions and Bochner integral projections have been formally proven, leaving zero 
\texttt{sorryAx} placeholders. The capstone relies solely on
...
\bottomrule
\end{tabular}
\caption{Complete axiom dependency of \texttt{certified\_attention\_contract}. \textbf{Zero domain axioms, zero admitted proofs.}}
\end{table}
